        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ url('/managementprojek/dataprojek') }}">Data Projek</a></li>
                    <li><a class="nav-link beep beep-sidebar" href="{{ url('/managementprojek/dokumenprojek') }}">Document Projek</a></li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ url('/personilprojek') }}">Personil Projek</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i><span>Learning Path</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ url('/targetpembelajaran') }}">Target Pembelajaran</a></li>
                    <li><a class="nav-link" href="{{ url('/targetpembelajaran') }}">Realisasi Pembelajaran</a></li>
                </ul>
            </li>
